...
def write_data_into_textfile(studList):
    datalines =[]
    ...
    with open(file_path + 'Student.txt','w') as file:
        for lines in datalines:
            file.writelines(lines)
    print("Student Data are added in Student.txt file.....")

def read_data_from_textfile():
    #reading from file
    print("Read Data from Student.txt file.....")
    slist = []
...
#call function
write_data_into_textfile(studList)
